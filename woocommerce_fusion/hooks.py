...
safe_exec = {
    # limit precisely what you need
    "allowed_imports": [
        "woocommerce_fusion.integrations.wp_media",
        "woocommerce_fusion.integrations",
        "requests",    # wp_media uses requests
        "mimetypes",   # used in the helper
        "posixpath",   # used in the helper
    ]
}